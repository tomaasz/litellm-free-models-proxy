...
<title>Free LLM Models — live list</title>
<style>
  :root {{
...
<header>
  ...
  <p class="subtitle">
    Live list of models available on free / trial tiers — auto-updated every 8 hours.<br>
  ...
  <div class="stats">
    <div class="stat"><strong>{total_models}</strong>models total</div>
...
<div class="suggest-card">
  <div class="suggest-text">
    ...
    <p>If you know of a provider that offers free access to AI models and isn't listed here,
    open a GitHub issue — we'll add support for it.</p>
  </div>
  <a class="suggest-btn"
...
<footer>
  ...
  Not affiliated with any provider. Availability may change without notice.</p>
</footer>
<script>
